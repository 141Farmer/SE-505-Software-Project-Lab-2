    ...
    <div className="min-h-screen flex items-center justify-center bg-green-100">
      ...
      <div className="bg-white p-8 rounded-lg shadow-lg text-center max-w-md w-full space-y-6">
        ...
        <p className="text-gray-600 px-4">
          There was an issue processing your Investment. Please verify your payment details and try again later.
        </p>
...
export default InvestmentFailure;